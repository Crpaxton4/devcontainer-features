"""Deprecated shim: :mod:`odoo_sdk.prune` moved to :mod:`odoo_sdk.tracking.prune` (#717).
...
from odoo_sdk.tracking import prune as _relocated

warnings.warn(
    "odoo_sdk.prune is deprecated; import odoo_sdk.tracking.prune instead "
