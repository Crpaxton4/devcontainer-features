"""Deprecated shim: :mod:`odoo_sdk.utilities.knowledge` moved to :mod:`odoo_sdk.services.knowledge` (#717).
...
from odoo_sdk.services import knowledge as _relocated

warnings.warn(
    "odoo_sdk.utilities.knowledge is deprecated; import odoo_sdk.services.knowledge instead "
