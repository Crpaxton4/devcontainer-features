"""Deprecated shim: :mod:`odoo_sdk.utilities.runs` moved to :mod:`odoo_sdk.tracking.runs` (#717).
...
from odoo_sdk.tracking import runs as _relocated

warnings.warn(
    "odoo_sdk.utilities.runs is deprecated; import odoo_sdk.tracking.runs instead "
