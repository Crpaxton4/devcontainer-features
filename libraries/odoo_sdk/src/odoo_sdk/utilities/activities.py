"""Deprecated shim: :mod:`odoo_sdk.utilities.activities` moved to :mod:`odoo_sdk.services.activities` (#717).
...
from odoo_sdk.services import activities as _relocated

warnings.warn(
    "odoo_sdk.utilities.activities is deprecated; import odoo_sdk.services.activities instead "
