"""Deprecated shim: :mod:`odoo_sdk.utilities.mail_status` moved to :mod:`odoo_sdk.services.mail_status` (#717).
...
from odoo_sdk.services import mail_status as _relocated

warnings.warn(
    "odoo_sdk.utilities.mail_status is deprecated; import odoo_sdk.services.mail_status instead "
