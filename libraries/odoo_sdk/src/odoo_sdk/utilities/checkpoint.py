"""Deprecated shim: :mod:`odoo_sdk.utilities.checkpoint` moved to :mod:`odoo_sdk.tracking.checkpoint` (#717).
...
from odoo_sdk.tracking import checkpoint as _relocated

warnings.warn(
    "odoo_sdk.utilities.checkpoint is deprecated; import odoo_sdk.tracking.checkpoint instead "
