"""Deprecated shim: :mod:`odoo_sdk.utilities.attachments` moved to :mod:`odoo_sdk.services.attachments` (#717).
...
from odoo_sdk.services import attachments as _relocated

warnings.warn(
    "odoo_sdk.utilities.attachments is deprecated; import odoo_sdk.services.attachments instead "
