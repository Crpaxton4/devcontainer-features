"""Deprecated shim: :mod:`odoo_sdk.utilities.stats` moved to :mod:`odoo_sdk.tracking.stats` (#717).
...
from odoo_sdk.tracking import stats as _relocated

warnings.warn(
    "odoo_sdk.utilities.stats is deprecated; import odoo_sdk.tracking.stats instead "
