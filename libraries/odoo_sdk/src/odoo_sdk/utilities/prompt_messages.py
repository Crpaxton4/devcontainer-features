"""Deprecated shim: :mod:`odoo_sdk.utilities.prompt_messages` moved to :mod:`odoo_sdk.mcp.prompts.messages` (#717).
...
from odoo_sdk.mcp.prompts import messages as _relocated

warnings.warn(
    "odoo_sdk.utilities.prompt_messages is deprecated; import odoo_sdk.mcp.prompts.messages instead "
