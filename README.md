...
See [`src/features/personal-features/NOTES.md`](src/features/personal-features/NOTES.md) for more detail.
...
`src/features/personal-features/README.md` is auto-generated by the release workflow from `devcontainer-feature.json` merged with `NOTES.md` — don't hand-edit it.
