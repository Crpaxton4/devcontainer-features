...
See [`features/src/personal-features/NOTES.md`](features/src/personal-features/NOTES.md) for more detail.
...
`features/src/personal-features/README.md` is auto-generated by the release workflow from `devcontainer-feature.json` merged with `NOTES.md` — don't hand-edit it.
